...
public class VueJest extends JPanel{
	...
	private LinkedList<Image> jest;
	
	public VueJest(){
		super();
		this.setLayout(new BorderLayout());
		this.setOpaque(false);
		this.jest = new LinkedList<Image>();
	}
	...
	public void ajouterAuJest(Image c){
		this.jest.add(c);
	}
	
	public LinkedList<Image> getJest() {
		return jest;
	}
